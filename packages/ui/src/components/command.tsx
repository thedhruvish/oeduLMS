...
import { InputGroup, InputGroupAddon } from "@oedulms/ui/components/input-group";
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        <Command className="[&_[data-slot=command-input-wrapper]_svg]:size-5 [&_[data-slot=command-input]]:h-12 [&_[data-slot=command-item]]:px-3 [&_[data-slot=command-item]]:py-3 [&_[data-slot=command-item]_svg]:size-5">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
