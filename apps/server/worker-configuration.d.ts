...
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 633ab735f35b4a649e2f4baea98dcc85)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "CORS_ORIGIN" | "DATABASE_URL" | "S3_PUBLIC_URL" | "S3_ENDPOINT" | "S3_BUCKET" | "S3_REGION" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "RAZORPAY_KEY_ID" | "RAZORPAY_KEY_SECRET" | "RAZORPAY_WEBHOOK_SECRET" | "RESEND_API_KEY">> {}
}
